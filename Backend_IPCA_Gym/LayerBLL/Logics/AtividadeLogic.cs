...
namespace LayerBLL.Logics
{
    ...
    public class AtividadeLogic
    {
        ...
        /// <summary>
        /// Método que recebe os dados do serviço de obter todas as atividades de um cliente
        /// </summary>
        /// <param name="sqlDataSource">String de Conexão à database</param>
        /// <param name="targetID">ID do cliente a retornar as atividades</param>
        /// <returns>Resposta do pedido feito no serviço</returns>
        /// <exception cref="SqlException">Ocorre quando há um erro na conexão com a base de dados.</exception>
        /// <exception cref="InvalidCastException">Ocorre quando há um erro na conversão de dados.</exception>
        /// <exception cref="InvalidOperationException">Trata o caso em que ocorreu um erro de leitura dos dados</exception>
        ...
        public static async Task<Response> GetAllByClienteIDLogic(string sqlDataSource, int targetID)
        {
            ...
            try
            {
                List<Atividade> atividadeList = await AtividadeService.GetAllByClienteIDService(sqlDataSource, targetID);
        ...
        /// <summary>
        /// Método que recebe os dados do serviço de obter todas as atividades de um ginasio
        /// </summary>
        /// <param name="sqlDataSource">String de Conexão à database</param>
        ...
        /// <exception cref="IndexOutOfRangeException">Trata o caso em que o índice da coluna da base de dados acessado é inválido</exception>
        /// <exception cref="Exception">Ocorre quando ocorre qualquer outro erro.</exception>
        public static async Task<Response> GetAllbyGymLogic(string sqlDataSource, int targetID)
        {
            Response response = new Response();

            try
            {
                List<Atividade> atividadeList = await AtividadeService.GetAllbyGymService(sqlDataSource, targetID);
        ...
        /// <summary>
        /// Método que recebe os dados do serviço de obter as estatísticas de um ginásio
        /// </summary>
        /// <param name="sqlDataSource">String de Conexão à database</param>
        /// <param name="targetID">ID do ginasio em causa</param>
        /// <returns>Resposta do pedido feito no serviço</returns>
        ...
        /// <exception cref="IndexOutOfRangeException">Trata o caso em que o índice da coluna da base de dados acessado é inválido</exception>
        /// <exception cref="Exception">Ocorre quando ocorre qualquer outro erro.</exception>
        public static async Task<Response> GetGymStatsLogic(string sqlDataSource, int targetID)
        {
            Response response = new Response();

            try
            {
                StatsModel stats = await AtividadeService.GetGymStatsService(sqlDataSource, targetID);

                if (stats != null)
                {
                    response.StatusCode = StatusCodes.SUCCESS;
                    response.Message = "Estatísticas do ginásio obtidas com sucesso";
                    response.Data = new JsonResult(stats);
                }
